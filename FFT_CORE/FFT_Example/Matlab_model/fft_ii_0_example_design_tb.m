...
fidr = fopen('fft_ii_0_example_design_real_input_1.txt','r');                                            

fidi = fopen('fft_ii_0_example_design_imag_input_1.txt','r');                                           
...
[y, exp_out] = fft_ii_0_example_design_model(x,N,1); 

fidro = fopen('fft_ii_0_example_design_real_output_c_model_1.txt','w');                                 

fidio = fopen('fft_ii_0_example_design_imag_output_c_model_1.txt','w');                                  

fideo = fopen('fft_ii_0_example_design_exponent_out_c_model_1.txt','w');                                 
