...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_text_pkg.vhd"                    -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_math_pkg.vhd"                    -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_lib_pkg.vhd"                     -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_roundsat.vhd"                    -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_sink.vhd"       -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_source.vhd"     -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_controller.vhd" -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/avalon_utilities_pkg.sv"                   -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/verbosity_pkg.sv"                          -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/altera_avalon_clock_source.sv"             -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/altera_avalon_reset_source.sv"             -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/altera_avalon_st_sink_bfm.sv"              -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/altera_avalon_st_source_bfm.sv"            -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../src/fft_ii_0_example_design.v"                 -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/fft_ii_0_example_design_core.sv"           -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../src/fft_ii_0_example_design_tb.v"              -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../src/fft_ii_0_example_design_test_program.sv"   -work work -cdslib ./cds_libs/work.cds.lib
fi
