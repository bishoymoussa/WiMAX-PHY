...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="NO" INIT_FILE="Real_input.mif" NUMWORDS_A=128 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=7 address_a clock0 data_a q_a rden_a wren_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_8.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_9.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_10.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_11.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_12.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_13.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_14.init_file = "Real_input.mif",
	...
	defparam
		...
		ram_block1a_15.init_file = "Real_input.mif",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file Real_input.mif is not found. This may result in inconsistent simulation results.");
	end
endmodule //Real_input_altsyncram
//VALID FILE
...
`endif
	...
	Real_input_altsyncram	Real_input_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
