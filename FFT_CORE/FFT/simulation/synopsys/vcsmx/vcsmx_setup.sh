...
# ACDS 17.0 595 win32 2018.04.16.13:05:14
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_1n128cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_2n128cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_1n128sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_2n128sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_3n128cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/FFT_fft_ii_0_3n128sin.hex ./
fi
