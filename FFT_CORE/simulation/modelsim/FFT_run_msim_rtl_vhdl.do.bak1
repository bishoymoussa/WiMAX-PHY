...
vcom -93 -work work {E:/Kolya/logic2/Spring2018_CMPN111/IP_Catalog/FFT/testbench/FFT_tb/simulation/FFT_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -L fft_ii_0 -voptargs="+acc"  FFT_tb.vhd
